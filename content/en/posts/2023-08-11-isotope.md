...
My note of stable isotope analysis, an effective method to rescontruct human diet. 

{{< end >}}

To explain "why do C3 plants and C4 plants differ in stable carbon isotope", we start from *photosynthesis* and *photorespiration* first.
...
They live in wet and cold environment, and they simply keep stomata open to minimize photorespiration. By doing this, C3 plants can absorb co2 and release O2 at the same time. C3 plants will generate a 3-carbon compound. The photosynthesis is carried out in the mesophyll cells. C3 carbon fixation is the most common pathway of photosynthesis.
...
C3 plants includes maize, mille tand etc.
...
{{<figure src="https://hellenshengfy.github.io/C4.png" title="Photo credit to [Professor Dave Explains](https://youtu.be/8oodcy8SEBk?si=d4Xh8m2CpBZ2rU63)">}}

{{<figure src="https://hellenshengfy.github.io/C5.png" title="Photo credit to [Neural Academy](https://youtu.be/Lhd7WbWV8aw?si=9ZshkSyybcEju7b8)">}}
...
{{<figure src="https://hellenshengfy.github.io/C8.png" title="Photo credit to https://youtu.be/v0dgJ4JMNrE?si=9fwlD3ZQi-IVe5Ro">}}

Discrimination against C13 (∂C13) is thus more negative ∂C13 for C3 plants to reflects their greater (direct) usage of the lighter C12O2. Generally, terrestrial C4 plants have ∂C13 value of −9‰ to −16‰ while terrestrial C3 plants have ∂C13 value of −23‰ to −30‰. 
