...
Here you may not able to save the file in the location you want (The ArcMap may prompt a "fail" notice, a bug??). If this happened, just save with the default name and default location. 
