...
Here you may not able to save the file in the location you want (The software may prompt a "fail" notice, a bug??). If this happened, just save with the default name and default location. 
...
**Step 9: final adjust the layout by zoom out and zoom in the area . Adjust all other things for better illustration**
